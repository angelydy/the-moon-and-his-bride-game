...
label day_0:
    ...
    label morning_0:
        ...
        label bath_0:
            scene bath
            #bath sound effect
            mc "{cps=25}My name is [mc]"
            mc "{cps=25}I am a just your typical simple person {p}trying to get by through college"
            mc "{cps=25}I study in the morning till afternoon"
            mc "{cps=25}and during evening I work as a part timer to get by from my day to day bills"
        ...
        label breakfast_0:
            ...
            mc "{cps=25}Done {p}Hmmm..."
            mc "I still have a... {p}little bit of time"
            jump news_0
        ...
        label school_0:
            ...
            "{color=#ffffff}Professor{/color}" "{cps=25}Take a sit class. So we can start"
    ...
    label afternoon_0:
        ...
        label fansign_0:
            "{cps=25}You accompanied Jenny in the Fan sign event"
            jump evening_0

    label evening_0:
        scene black
        centered "{color=#cc6600}Evening{/color}"
        #scene Mansion_entrance evening
        ...
        label solo_0:
            ...
            if canteen0 == False:
                ln "{cps=25}Hey, [mc] Jake's been looking for you"
                $ findjake = True
            else:
                ln "{cps=25}Hey, [mc] where you've been?"
            ln "{cps=25}Hmm..."
            ln "{cps=25}What's wrong?"
            mc "{cps=25}Nothing"
            jr "{cps=25}I'm going to get a drink"
            "([jr] walked towards you and whispered)"
            ...
            ln "{cps=25}Oh yeah [mc] been looking for you in the Living Room"
            mc "{cps=25}Thanks Lucas I'll be heading there now"
            "(You went back to the lobby)"
            jump jaketalk_0
        ...
        label jaketalk_0:
            ...
            jk "{cps=25}"
            jk "{cps=25}Thiss iz like..."
            jk "{cps=25}Stuf... ssomeething that puts my mind at ease"
