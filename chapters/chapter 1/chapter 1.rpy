...
label canteen_ch1:
    ...
    show lucas neutral with moveinright
    ln"{cps=25} …"
...
label home_ch1:
    ...
    hide screen phone
    scene tv_close hand with dissolve
...
label checkHouse_ch1:
    ...
    $ raid_ch1.incProgress()
    "[raid_ch1.completed]"
    if raid_ch1.completed:
        $ raid2_ch1.available = True
    return
...
label f2hallway_ch1:
    ...
    scene club_room afternoon with dissolve
    show laura chuckle with moveinleft
...
label cafe_ch1:
    ...
    $ inventory.items.append(vidfile)
    $ evidence_ch1.available = True
    $ renpy.block_rollback()
    return

label homeevening2_ch1:
    $ evidence_ch1.triggered = True
    ...
    $ raid_ch1.incProgress()
    "[raid_ch1.completed]"
    if raid_ch1.completed == True:
        $ raid2_ch1.available = True
    return

label canteen2_ch1:
    $ raid2_ch1.completed = True
    hide screen phone
    #School Canteen
    scene canteen day with fade
    show laura neutral at left with moveinleft
...
label jaketalk_ch1:
    if inventory.itemCheck(knuckle):
        hide screen phone
        ...
        if start2_raid_ch1.completed == True:
            scene black with dissolve
            centered "{color=#FFF}Evening{/color}" with fade
            jump raid_ch1
    else:
        mc"{cps=25} Nothing..."
        jk"{cps=25} Aight, talk to me when you're ready"
    return

label lauratalk_ch1:
    if inventory.itemCheck(ketchup):
        hide screen phone
        lg"{cps=25} Hmm?"
        mc"{cps=25} We’ll go during the evening let’s meet in Lucas’s House"
        ...
        mc"{cps=25} Nothing..."
        lg"{cps=25} Okay, talk to me when you're done preparing"
    return
